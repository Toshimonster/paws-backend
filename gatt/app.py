...
class PAWS(Service):
    UUID = '44e268f0-2f85-11ec-8d3d-0242ac130003'
    """
    Protogen Service
    """
    def __init__(self, bus, index):
        Service.__init__(self, bus, index, self.UUID, True)
        self.add_characteristic(PAWS_Uptime_Characteristic(bus, 0, self))
        self.add_characteristic(BodySensorLocationChrc(bus, 1, self))
        self.add_characteristic(HeartRateControlPointChrc(bus, 2, self))

class PAWS_Uptime_Characteristic(Characteristic):
    UUID = '5504de8e-2f85-11ec-8d3d-0242ac130003'
    def __init__(self, bus, index, service):
        ...
        #self.add_descriptor(PAWS_Uptime_Description_Descriptor)
    ...
    def ReadValue(self, options):
        with open('/proc/uptime', 'r') as f:
            ...
            print(secs.to_bytes(4))
            return [secs.to_bytes(4)]

class PAWS_Uptime_Description_Descriptor(Descriptor):
    UUID = "2901"
    ...
    def ReadValue(self, options):
        return str.encode('The uptime for the operating system')
