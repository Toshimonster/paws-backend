...
if (require.main === module) {
    ...
    Proto.addInterfaces([
        new Paws.Interfaces.TextInterface("TestInterface", {
            y: 10,
            x: 10,
            symbol: "!"
        }),
        new Paws.Interfaces.RpiMatrixInterface("Front P3 Matrices", {
            matrixOpts: {
        ...
        new Paws.Interfaces.Ws281xInterface("Ws2812b", 61 * 2, {
            gpio: 21,
            stripType: 'ws2812',
            brightness: 5
        })
    ...
    |_|    \__,_|_|___/\___|_|  |_|  \__,_|___/\__|
        ...
        */
        new Paws.States.Pulser("PulserFast", {
            interfaces: [
                "Front P3 Matrices",
                "Ws2812b",
            ],
    ...
    |_|    \__,_|_|___/\___|_|  |____/|_|\___/ \_/\_/
        ...
        */
        new Paws.States.Pulser("PulserSlow", {
            interfaces: [
                "Front P3 Matrices",
                "Ws2812b",
            ],
     ...
     \____|_|   \__, |
        ...
        */
        new Paws.States.GifState("Cry", {
            ...
            {
                from: ["Idle"],
                state: new Paws.States.GifState("Idle-Cry", {
                    verbose: true,
                    interfaceDefinitions: [
                        {
                            interface: "Front P3 Matrices",
    ...
    /_/   \_\_| |_|\__, |_|   \__, |
        ...
        */
        new Paws.States.GifState("Angry", {
            verbose: true,
            interfaceDefinitions: [
                {
                    interface: "Front P3 Matrices",
            ...
            {
                from: ["Idle", "Cry"],
                state: new Paws.States.GifState("Idle-Angry", {
                    verbose: true,
                    interfaceDefinitions: [
                        {
                            interface: "Front P3 Matrices",
    ...
    |____/|_|\__,_|\___||___/\___|_|  \___|\___|_| |_|
        ...
        */
        new Paws.States.GifState("Bluescreen", {
            verbose: true,
            interfaceDefinitions: [
                {
                    interface: "Front P3 Matrices",
            ...
            {
                from: ["Idle", "Cry"],
                state: new Paws.States.GifState("Idle-Bluescreen", {
                    verbose: true,
                    interfaceDefinitions: [
                        {
                            interface: "Front P3 Matrices",
